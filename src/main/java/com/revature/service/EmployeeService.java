...
public class EmployeeService {
	...
	public Employee confirmLogin(String username, String password) {
		// TODO fix this issue should be OPTIONAL
		...
		// try {
		// throw new NoUserFoundException("User with username " + username + " does not
		// exist!");
		// } catch (NoUserFoundException e) {
		// e.printStackTrace();
		// }
		// } else if (possibleEmp.getPassword() != null && possibleEmp.getPassword() !=
		// password) {
		// try {
